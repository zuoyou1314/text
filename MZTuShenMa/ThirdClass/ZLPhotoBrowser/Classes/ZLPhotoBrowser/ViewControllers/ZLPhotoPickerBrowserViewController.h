...
typedef NS_ENUM(NSUInteger,ZLPhotoPickerBrowserViewControllerType){
    ZLPhotoPickerBrowserViewControllerTypePhotoList,
    ZLPhotoPickerBrowserViewControllerTypePhotoDetail,
};

// 用于标识是否需要是公关相册
typedef NS_ENUM(NSUInteger,ZLPhotoPickerBrowserViewType) {
    ZLPhotoPickerBrowserViewTypePublicAlbum,//公共相册动态详情
    ZLPhotoPickerBrowserViewTypeNormal//普通相册动态详情
};
...
//枚举
@property (nonatomic,assign) ZLPhotoPickerBrowserViewControllerType type;
@property (nonatomic, assign) ZLPhotoPickerBrowserViewType albumType;
