...
//        [toolBar setBackgroundImage:[[UIImage imageNamed:@"keyBoardBack"] resizableImageWithCapInsets:insets] forToolbarPosition:0 barMetrics:0];
        ...
        //可以自适应高度的文本输入框
        textView = [[UITextView alloc] initWithFrame:CGRectMake(0, 0, 210, 36)];
        textView.scrollIndicatorInsets = UIEdgeInsetsMake(4.0f, 0.0f, 10.0f, 0.0f);
...
//改变键盘高度
//-(void)TextView:(UIExpandingTextView *)expandingTextView willChangeHeight:(float)height
//{
